...
var Video      = require("../models/videoInfo");
...
module.exports = function(app, express) {
	...
	apiRouter.post('/sample', function(req, res) {
		...
		User.findOne({ 'username': 'chris' }, function(err, user) {
			...
			if (!user) {
				...
				sampleUser.password =  user.encryptPassword('supersecret');  //此处需要现在上数据库中添加chris记录
	...
	apiRouter.post("/getvideoinfo",function(req,res){
		console.log("api.js");
